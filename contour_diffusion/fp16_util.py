...
def make_master_params(param_groups_and_shapes):
    """
    Copy generator parameters into a (differently-shaped) list of full-precision
    parameters.
    """
    master_params = []
...
def model_grads_to_master_grads(param_groups_and_shapes, master_params):
    """
    Copy the gradients from the generator parameters into the master parameters
...
def master_params_to_model_params(param_groups_and_shapes, master_params):
    """
    Copy the master parameter data back into the generator parameters.
    """
