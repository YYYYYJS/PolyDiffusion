...
def get_demo(layout_to_image_generation_fn, cfg, model_fn, noise_schedule):
    ...
    with gr.Blocks() as demo:
        ...
        Please note that the generator is not pretrained on models like Stable Diffusion and is trained from scratch only on a small subset of COCO-stuff dataset in pixel-space. 
