...
# sample 2048 x 1, 2048 image ids can be found in contour_diffusion/dataset/image_ids_layout2i_2048.txt, should copy it into annotations/deprecated-challenge2017
CUDA_VISIBLE_DEVICES=0,1 \
python -m torch.distributed.launch  \
      --nproc_per_node 2 \
      scripts/classifier-free_sample_for_layout.py  \
