...
CKPT_MAP = {
    "cifar10": "diffusion_cifar10_model/generator-790000.ckpt",
    "ema_cifar10": "ema_diffusion_cifar10_model/generator-790000.ckpt",
    "lsun_bedroom": "diffusion_lsun_bedroom_model/generator-2388000.ckpt",
    "ema_lsun_bedroom": "ema_diffusion_lsun_bedroom_model/generator-2388000.ckpt",
    "lsun_cat": "diffusion_lsun_cat_model/generator-1761000.ckpt",
    "ema_lsun_cat": "ema_diffusion_lsun_cat_model/generator-1761000.ckpt",
    "lsun_church": "diffusion_lsun_church_model/generator-4432000.ckpt",
    "ema_lsun_church": "ema_diffusion_lsun_church_model/generator-4432000.ckpt",
}
MD5_MAP = {
...
def get_ckpt_path(name, root=None, check=False):
    ...
    if not os.path.exists(path) or (check and not md5_hash(path) == MD5_MAP[name]):
        print("Downloading {} generator from {} to {}".format(name, URL_MAP[name], path))
